...
if __name__ == "__main__":
    src_dir=r"C:\Users\brighten\Desktop\origin"
    save_dir=r"C:\Users\brighten\Desktop\11"
    # jizhun_dir=r"C:\Users\brighten\Desktop\act_well\RRU_coverage"
    files = os.listdir(src_dir)
    for name in files:
        # src_size = find_src_shape(jizhun_dir, name)
        # print(src_size)
        src=Image.open(src_dir+"/"+name).convert("RGB")
        src=np.array(src)

        src_re=BiLinear_interpolation(src,585,585)
